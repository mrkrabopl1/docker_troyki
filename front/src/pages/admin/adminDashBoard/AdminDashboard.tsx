    ...
    return (
        <div className={s.dashboard}>
            ...
            <div className={s.statsGrid}>
                <div className={s.statCard} onClick={() => navigate('/admin/products')}>
                ...
                <div className={s.statCard} onClick={() => navigate('/admin/orders')}>
            ...
            <div className={s.quickActions}>
                ...
                <div className={s.actionsGrid}>
                    ...
                    <button onClick={() => navigate('/admin/sales/create')}>
                        🏷️ Создать скидку
                    </button>
