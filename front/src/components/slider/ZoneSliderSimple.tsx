        ...
        <div
         style={styleWrapper} ref={wrappRef}>
            <div className={s.sliderLine} style={
                ...
                <div className={s.sliderControl} onMouseDown={mouseDownLeft} ref={sliderRefLeft} style={sliderStyleLeft}></div>
                <div className={s.sliderControl} onMouseDown={mouseDownRight} ref={sliderRefRight} style={sliderStyleRight}></div>
            </div>
        </div>
    )
}
